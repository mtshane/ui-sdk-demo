...
export class LayoutComponentView {
	...
	get_viewSidebarToggler = function() {
		return element(by.css('app-root app-layout-main kg-view-main .page .page-row .main-wrap .main-header kg-toolbar .sidebar-toggler'));
	};

	get_viewAppHeader = function() {
		return element(by.css('app-root app-layout-main kg-view-main .page .page-row .main-wrap .main-header kg-toolbar'));
	};
